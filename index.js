...
console.log(color('\nYou can follow me on GitHub: hackerz-lab','aqua'))
    ...
    const Miku = MikuConnect({
        ...
        browser: ['Makise by: Hackerz Lab','Safari','1.0.0'],
        auth: state,
        version
    })
...
Miku.ev.on('groups.update', async pea => {
       ...
       ppgc = 'https://images6.alphacoders.com/471/thumb-1920-471586.png'
       }
        ...
        try {
            ...
            for (let num of participants) {
                ...
                try {
                    ...
                    ppuser = 'https://images7.alphacoders.com/344/344982.jpg'
                }

                try {
                    ppgroup = await Miku.profilePictureUrl(anu.id, 'image')
                } catch {
                    ppgroup = 'https://images7.alphacoders.com/344/344982.jpg'
                }
...
I am *Makise Kurisu*, Welcome to ${metadata.subject}.

*Group Description:*
${metadata.desc}

Press the button below to start using *Makise*...`

let Mikubuttons = [
    {buttonId: `-menu`, buttonText: {displayText: 'Use Makise'}, type: 1}
    ]
    let buttonMessage = {
