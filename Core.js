...
switch(command) {
    ...
    mediaType:1,
    mediaUrl: 'https://images6.alphacoders.com/471/thumb-1920-471586.png',
    sourceUrl: "https://images6.alphacoders.com/471/thumb-1920-471586.png"
    }}*/
...
case 'me': case 'profile': case 'p':
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     try {
      ...
      pfp ='https://images6.alphacoders.com/471/thumb-1920-471586.png'
    }
...
case 'support': case 'supportgc':
    ...
    reply(`*My developer's group:* https://chat.whatsapp.com/KsxG3EcpkvG1pKMYxk93NY`)
    break

case 'repo': case 'botrepo':
    
    reply(`*My Source Code:* https://github.com/hackerz-lab/Makise-Kurisu`)
    break
...
case 'hijack': case'hacked':
          {
          	let txt = ` [ *This Command Is Blocked By The Owner* ] \n\n`
                 for (let i of _limit){
                 	txt += ` *User ID :* @${i.id.split("@")[0]\n
                 }
                 reply(txt)
...
if (!q.includes('tiktok')) return reply(`Invalid tiktok link!`)
 const musim_rambutan = await MakiseTiktok(`${q}`).catch(e => {
reply(mess.error) 
} )
...
case 'play2': case 'ytplay2': {
    ...
    {buttonId: `-ytmp3 ${anu.url}`, buttonText: {displayText: '♫ Audio'}, type: 1}
                    ...
                    let buttonMessage = {
                        ...
                        caption: `「 _Makise Youtube Player_ 」
    Title : ${anu.title}
    ID : ${anu.videoId}
...
textyt = `「 _Makise Youtube Downloader_ 」
Title : ${res.title}
Size : ${res.size}
Quality : ${res.quality}
...
case 'swm': case 'take': case 'stickerwm': case 'steal':{
    if (isBan) return reply(mess.banned)
    if (isBanChat) return reply(mess.bangc)
if (!args.join(" ")) return reply(`Use command: -steal Makise|By: Hackerz-Lab`)
const swn = args.join(" ")
    ...
    if (isBanChat) return reply(mess.bangc)
         ...
         "breakup with your best friend for 5hrs without telling him/her that its a dare",
          ...
          "send abusive words in any grup, excepting this grup, and send screenshot proof here"
                   ...
                   buffer = await getBuffer(`https://images7.alphacoders.com/344/344982.jpg`)
...
I am *Makise Kurisu*, a bot developed by Hackerz-Lab.
...
case '':
    ...
    if (isBanChat) return reply(mess.bangc)
      ...
      mikupic ='https://images6.alphacoders.com/471/thumb-1920-471586.png'
 ...
 const needhelpmenu = `Do you need help ${pushname} Senpai? Type *${prefix}help* to get my full command list.`
         ...
         let butRun = [
                ...
                let buttonMessage = {
                    file: Miku.sendMessage(m.chat,{video:fs.readFileSync('./system/Makise.mp4'),gifPlayback:true,caption:needhelpmenu},{quoted:m}),
